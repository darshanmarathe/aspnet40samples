<%@ Page Title="The ScriptLoader" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="scriptloader.aspx.cs" Inherits="AspNet4Prac.scriptloader" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<h2>The ScriptLoader</h2>
<hr />
<p>Loads the javascript file and fires a READY event </p>
<br /><br /><br />
